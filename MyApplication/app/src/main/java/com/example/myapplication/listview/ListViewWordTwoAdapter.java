...
import com.example.myapplication.activity.UpdateSetActivity;

import java.util.ArrayList;

public class ListViewWordTwoAdapter extends BaseAdapter {
    ...
    public ListViewWordTwoAdapter(UpdateSetActivity ma) {
        this.m = ma;
    }
    ...
    public void addItem(String wordA, String wordB, int num){
