...
public class ListViewFolderAdapter extends RecyclerView.Adapter<ListViewFolderAdapter.CustomViewHolder>{

    private ArrayList<ListViewFoldItem> listViewItemList = new ArrayList<ListViewFoldItem>() ;

    private FragmentHome.Command command;

    //생성자에서 데이터 리스트 객체를 전달받음
    public ListViewFolderAdapter(ArrayList<ListViewFoldItem> list, FragmentHome.Command com) {
        ...
        public CustomViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    command.onClicked((String)titleTextView.getText(), folder_no, (String)descTextView.getText());
                }
            });
            //롱클릭시 폴더리스트 삭제요청
