...
public class ListViewSetAdapter extends RecyclerView.Adapter<ListViewSetAdapter.CustomViewHolder>{

    private ArrayList<ListViewSetItem> listViewItemList = new ArrayList<ListViewSetItem>() ;
    private FragmentSetlist.SetCommand command;

    //생성자에서 데이터 리스트 객체를 전달받음
    public ListViewSetAdapter(ArrayList<ListViewSetItem> list, FragmentSetlist.SetCommand com) {
